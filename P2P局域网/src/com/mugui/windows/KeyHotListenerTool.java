...
public class KeyHotListenerTool implements Runnable {

	private static KeyHotListenerTool mouseListenerTool = null;

	public static final KeyHotListenerTool newInstance() {
		if (mouseListenerTool != null)
			return mouseListenerTool;
		return mouseListenerTool = new KeyHotListenerTool();
	}
