...
public class TcpSocketClient extends TcpSocket {
	...
	public String getLocalHost() {
		return socketChannel.getLocalAddress().getHostAddress();
	}
	...
	public void run() {
		try {
			while (isTrue) {
				System.out.println("receive_thread->" + this.getId());
				receive();
				System.out.println("receive_end->" + this.getId()+isTrue);
			}
		} catch (Exception ex) {
			new Exception("end_thread->" + this.getId(), ex).printStackTrace();
		} 
	}
